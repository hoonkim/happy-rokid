...
export const LocalSettingsSchema = z.object({
    ...
    rokidBridgeEnabled: z.boolean().describe('Forward Happy session state through Hi Rokid CXR-L'),
    rokidPinnedSessionId: z.string().nullable().describe('Happy session pinned as the primary Rokid display'),
